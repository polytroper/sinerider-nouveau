...
module.exports = spec => {
  ...
  buildButton.append('div').text('EDIT')
    ...
    expressionHandles.call(
      d3
        ...
        .on('drag', function(d, i, a) {
          ...
          d3.select(this.parentNode).style('top', dragY - originY - dragOffsetY)
  ...
  var onSetMacroState = () => {
    ...
    playButton.select('.startButtonLabel').text(getRunning() ? 'STOP' : 'START')
